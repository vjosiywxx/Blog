        ...
        <table class = "posttable">
            <?php
              ...
              if ($_SERVER["REQUEST_METHOD"] == "POST"){
                $postCategory = isset($_POST["postCategory"]) ? $_POST["postCategory"] : "";
                $weatherCategory = isset($_POST["weatherCategory"]) ? $_POST["weatherCategory"] : "";
                $title = isset($_POST["title"]) ? $_POST["title"] : "";
                $date = isset($_POST["date"]) ? $_POST["date"] : "";
                $content = isset($_POST["content"]) ? $_POST["content"] : "";
            
                if (!empty($postCategory) && !empty($weatherCategory) && !empty($title) && !empty($date) && !empty($content)) {
                $query = $conn->prepare("INSERT INTO post(postCategory,weatherCategory,title,date,content)VALUES(?,?,?,?,?)");
                $query->bind_param("iisss", $postCategory, $weatherCategory, $title, $date,$content);
                $query->execute();
                ...
                if(isset($_POST['deletePost'])) {
                    ...
                    $deleteQuery->bind_param("i", $postIDToDelete);
                    $deleteQuery->execute();
